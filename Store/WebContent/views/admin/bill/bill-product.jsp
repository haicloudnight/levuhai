				...
				<table border="1">
					...
					<c:forEach items="${billProducts}" var="billProduct">
						<tr>
							...
							<td><a href="/Store/client/product/detail?id=${billProduct.product.id }">${billProduct.product.name }</a></td>
							<td><img src="/Store/download?image=${billProduct.product.image }" width="100" /></td>
