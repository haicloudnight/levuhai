	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-sm-12">
				<form action="/Store/admin/user/update" method="post">
					<div class="form-group">
						<label>ID:</label> <input name="id" value="${user.id}"
							class="form-control" type="text" readonly="readonly">
					</div>
					<div class="form-group">
						<label>Tên:</label> <input value="${user.name}"
							class="form-control" type="text" name="name"
							placeholder="Nhap ten">
					</div>
					<div class="form-group">
						<label>Tài khoản:</label> <input value="${user.username}"
					...
					<div class="form-group">
						<label>Gender : </label>
						<c:choose>
							<c:when test="${user.getGender().equals('M')}">
							...
							<c:otherwise>
								...
								<input type="radio" name="gender" value="F" checked="checked">Nu
			  				</c:otherwise>
						</c:choose>
					</div>
					<div class="form-group">
